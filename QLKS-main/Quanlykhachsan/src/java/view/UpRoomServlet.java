 ...
 * @author HP
 */
@WebServlet(name = "UpRoomServlet", urlPatterns = {"/suaroom"})
public class UpRoomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpRoomServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpRoomServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ArrayList<Loaiphong> lp = l.layTatCa(); 
            Phong b = p.layTheoId(id);
            request.setAttribute("data", b); 
            request.setAttribute("lphong", lp);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Phong d = new Phong(id,lp,tenphong,status,0);
            p.update(d); 
