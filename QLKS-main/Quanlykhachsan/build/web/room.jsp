<%-- 
    Document   : room
    Created on : May 6, 2023, 12:43:59 PM
    Author     : HP
--%>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="col-md-12  table-responsive">
        ...
        <a href="themroom"><button class="btn btn-success">Thêm Phòng</button></a>
        ...
        <table class="table table-bordered table-hover" 
            ...
            %>
                <tr>
                    ...
                    <td><%= i.getStatus()%></td>
                    <th style="width: 50px;">
                        <a href = "suaroom?id=<%= i.getId()%>"><button class="btn btn-warning">Sửa</button></a>
                    </th>
                    <th style="width: 50px;">
                        <a href = "xoaroom?id=<%= i.getId()%>"><button class="btn btn-danger">Xóa</button></a>
