<%-- 
    Document   : bookroom
    Created on : May 6, 2023, 10:03:54 PM
    Author     : HP
--%>
  ...
  <div class="row">
	...
	<div class="col-md-12  table-responsive">
        ...
        <table class="table table-bordered table-hover" 
            ...
            %>
                <tr>
                    <th><a href="detail?id=<%= i.getId()%>"><%=(++index)%></a></th>
                    <td><a href="detail?id=<%= i.getId()%>"><%= i.getKh().getHoten()%></a></td>
                    <td><a href="detail?id=<%= i.getId()%>"><%= i.getSongaythuco()%></a></td>
                    <td><a href="detail?id=<%= i.getId()%>"><%= i.getNgaydat()%></a></td>
                    <td><a href="detail?id=<%= i.getId()%>"><%= i.getNgaytra()%></a></td> 
                </tr>
            <%
                }
            %>
