<%-- 
    Document   : typeroom
    Created on : May 6, 2023, 7:54:00 PM
    Author     : HP
--%>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="col-md-12  table-responsive">
        ...
        <a href="addType.jsp"><button class="btn btn-success">Thêm loại phòng</button></a>
        ...
        <table class="table table-bordered table-hover" 
            ...
            <% 
                  int index = 0;
                  ArrayList<Loaiphong> list = (ArrayList<Loaiphong>) request.getAttribute("data") ;
            ...
            %>
                <tr>
                    ...
                    <td><%= i.getDongia()%></td>
                    <th style="width: 50px;">
                        <a href = "suatype?id=<%= i.getId()%>"><button class="btn btn-warning">Sửa</button></a>
                    </th>
                </tr>
            <%
                }
