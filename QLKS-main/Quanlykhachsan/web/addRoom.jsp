<%-- 
    Document   : addRoom
    Created on : May 6, 2023, 2:12:04 PM
    Author     : HP
--%>
	...
	<div class="col-md-12  table-responsive">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="themroom" method="post">
                    <div class="form-group">
                      <label for="tenphong">Tên Phòng:</label>
                      <input  type="text" class="form-control" id="usr" name="tenphong">
<!--                      <input type="text" name="id" value="<?=$id?>" hidden="true">-->
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="loaiphong" id="loaiphong" required="true">
                          <option>-- Chọn --</option>
                          <%
                            ArrayList<Loaiphong> l = (ArrayList<Loaiphong>)request.getAttribute("data");
                            for(Loaiphong i:l){
                           %>
