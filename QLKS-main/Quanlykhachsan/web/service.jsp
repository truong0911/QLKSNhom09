<%-- 
    Document   : service
    Created on : May 6, 2023, 3:28:55 PM
    Author     : HP
--%>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="col-md-12  table-responsive">
        ...
        <a href="addSer.jsp"><button class="btn btn-success">Thêm Dịch Vụ</button></a>
        ...
        <table class="table table-bordered table-hover" 
            ...
            %>
                <tr>
                    ...
                    <td><%= i.getGia()%></td>
                    <th style="width: 50px;">
                        <a href = "suadv?id=<%= i.getId()%>"><button class="btn btn-warning">Sửa</button></a>
                    </th>
                    <th style="width: 50px;">
                        <a href = "xoadv?id=<%= i.getId()%>"><button class="btn btn-danger">Xóa</button></a>
